...
import com.thesis.ClientApp.shareChat.Chat;
            ...
            if (fUser != null && sent.equals(fUser.getUid())){
                if (!savedCurrentUser.equals(user)){
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
                        sendOAndAboveNotificationDelete(remoteMessage);
                    }else {
...
//    }
    ...
    //Send Above Notification From Post on Delete, Pending, On Going, Done


    private void sendOAndAboveNotificationDelete(RemoteMessage remoteMessage){
        String user = ""+remoteMessage.getData().get("user");
        String icon = ""+remoteMessage.getData().get("icon");
        String title = ""+remoteMessage.getData().get("title");
        String body = ""+remoteMessage.getData().get("body");
