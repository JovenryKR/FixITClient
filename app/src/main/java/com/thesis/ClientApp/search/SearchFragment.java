package com.thesis.ClientApp.search;
...
import com.thesis.ClientApp.adapter.AdapterPost;
...
public class SearchFragment extends Fragment implements View.OnClickListener {
    ...
    RecyclerView username_rv, posts_rv, likes_rv, views_rv, comment_rv, meme_rv, vines_rv;
    ProgressBar pg;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        username_rv = view.findViewById(R.id.username);
    ...
    private void getViewsPost() { //First Filter
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Posts");
        Query q = ref.limitToLast(mCurrenPage * TOTAL_ITEMS_TO_LOAD);
        q.orderByChild("type").equalTo("Emergency").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                postList.clear();
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
    ...
    private void getMemePost() {
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Posts");
        Query q = ref.limitToLast(mCurrenPage * TOTAL_ITEMS_TO_LOAD);
        q.orderByChild("type").equalTo("Public Incidents").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                postList.clear();
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
        ...
        q.orderByChild("type").equalTo("Electrical Complaints").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                //postList.clear();
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
    ...
    private void getVinesPost() {
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Posts");
        Query q = ref.limitToLast(mCurrenPage * TOTAL_ITEMS_TO_LOAD);
        q.orderByChild("type").equalTo("Road Complaints").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                postList.clear();
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
        ...
        q.orderByChild("type").equalTo("Household Concerns").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                //postList.clear();
