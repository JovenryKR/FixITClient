package com.thesis.ClientApp.settings;
        ...
        switch (v.getId()){
            ...
            case R.id.delete:
                ...
                picRef.delete().addOnSuccessListener(aVoid -> {
                    ...
                    //ProfileSet
                    HashMap<String, Object> hashMap = new HashMap<>();
                    hashMap.put("photo", "https://firebasestorage.googleapis.com/v0/b/alpha-database-fixit.appspot.com/o/avatar.jpg?alt=media&token=eca560b5-4f0b-438e-9432-b570e543b63a");
                    DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Users");
                    reference.child(Objects.requireNonNull(mAuth.getUid())).updateChildren(hashMap)
                    ...
                    query.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            for (DataSnapshot ds: dataSnapshot.getChildren()){
                                String child = ds.getKey();
                                dataSnapshot.getRef().child(Objects.requireNonNull(child)).child("dp").setValue("https://firebasestorage.googleapis.com/v0/b/alpha-database-fixit.appspot.com/o/avatar.jpg?alt=media&token=eca560b5-4f0b-438e-9432-b570e543b63a");
                            }
